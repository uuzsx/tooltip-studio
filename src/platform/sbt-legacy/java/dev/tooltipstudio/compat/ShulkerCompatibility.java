...
/** Optional bridge for Shulker Box Tooltip 4.1.x. Not loaded when the mod is absent. */
public final class ShulkerCompatibility {
    ...
    public static boolean draw(TooltipComponent component, TextRenderer font, int x, int y, DrawContext context,
        ...
        if (TooltipRenderScope.hasScreen() && context instanceof DrawContextExtensions positions) {
